...
public class GemFgPool : MonoBehaviour 
{

	public static GemFgPool Instance { get; private set; }
	...
	public GemFg GetOneGemFg(int id)
	{
		GemFg gemObject = null;
		...
		if (usePool == true && poolItem != null && poolItem.Gems.Count > 0)
		{
			...
			gemObject = gem.GetComponent<GemFg>();
